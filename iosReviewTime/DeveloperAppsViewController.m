...
- (IBAction)refreshApps {
    ...
    [manager GET:requestURL parameters:nil success:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        if ([_developersArray count] > 1) {
            UIActionSheet *actionSheet = [[UIActionSheet alloc] initWithTitle:[NSString stringWithFormat:@"Many results found for \"%@\" found. Which one do you want to use?", developerNameOrId] delegate:self cancelButtonTitle:nil destructiveButtonTitle:nil otherButtonTitles:nil];
